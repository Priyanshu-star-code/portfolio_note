const skills = [
  {
    ...
    items: [
      ...
      "System Monitoring",
      "File Permissions & Networking Basics"
    ]
  },
  {
...
const SkillsSection = () => {
  return (
    <section className="py-20 notebook-page relative" id="skills">
      ...
      <div className="absolute top-[35%] right-[20%] animate-shooting-star-delayed">
        <svg width="60" height="20" viewBox="0 0 60 20" className="opacity-70">
          <defs>
            <linearGradient id="starTrail2" x1="0%" y1="50%" x2="100%" y2="50%">
              <stop offset="0%" stopColor="hsl(var(--doodle))" stopOpacity="0" />
              <stop offset="100%" stopColor="hsl(var(--doodle))" stopOpacity="1" />
            </linearGradient>
          </defs>
          <path d="M0 10 L50 10" stroke="url(#starTrail2)" strokeWidth="1.5" strokeLinecap="round" />
          <circle cx="50" cy="10" r="3" fill="hsl(var(--doodle))" />
        </svg>
      </div>
      ...
      <div className="container mx-auto px-8 md:px-20">
        ...
        <h2 className="font-handwriting text-5xl md:text-7xl text-ink mb-16 text-center">
          My <span className="highlight-text">DevOps Skills</span>
        </h2>
        ...
        <div className="flex justify-center mt-12 gap-8 opacity-50">
          ...
          <svg className="w-12 h-12" viewBox="0 0 50 50">
            <path
              d="M10 25 Q25 5 40 25 Q25 45 10 25"
              stroke="hsl(25 25% 35%)"
              strokeWidth="2"
              fill="none"
            />
